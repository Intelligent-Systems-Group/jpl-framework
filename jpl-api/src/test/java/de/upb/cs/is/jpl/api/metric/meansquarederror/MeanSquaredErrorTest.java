 ...
 *
 */
public class MeanSquaredErrorTest extends ADecomposableMetricTest<Double, Double> {
   private static final String RESOURCE_DIRECTORY_LEVEL = "meansquarederror" + File.separator;
   ...
   private static final Logger logger = LoggerFactory.getLogger(MeanSquaredErrorTest.class);


   /**
    * Creates a new {@link MeanSquaredErrorTest}
    */
