...
/**
 * This class test the {@link Subset01Loss}.
 * 
 * @author Alexander Hetzer
 *
 */
public class Subset01LossTest extends AAverageDecomposableIVectorDoubleMetricTest {

   private static final String RESOURCE_DIRECTORY_LEVEL = "subset01" + File.separator;


   /**
    * Creates a new {@link Subset01LossTest}.
    */
   public Subset01LossTest() {
   ...
   public List<Pair<Pair<IVector, IVector>, Double>> getCorrectListofPairsOfRatings() {
      ...
      correctListOfPairsOfRatings.add(TestUtils.getArgumentAndExpectedResultPair(firstRating2, secondRating2, 1.0));
      ...
      correctListOfPairsOfRatings.add(TestUtils.getArgumentAndExpectedResultPair(firstRating5, secondRating5, 1.0));
