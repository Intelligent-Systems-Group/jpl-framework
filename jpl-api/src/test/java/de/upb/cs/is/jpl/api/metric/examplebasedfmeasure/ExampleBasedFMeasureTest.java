...
/**
 * This test tests the {@link ExampleBasedFMeasure}.
 * 
 * @author Alexander Hetzer
 *
 */
public class ExampleBasedFMeasureTest extends ANonDecomposableMetricTest<IVector, Double> {

   private static final String RESOURCE_DIRECTORY_LEVEL = "example_based_f_measure" + File.separator;

   private static final String REFLECTION_ERROR_CANNOT_AVERAGE = "ERROR_CANNOT_AVERAGE";
   private static final String REFLECTION_ERROR_UNEQUAL_VECTOR_SIZES = "ERROR_UNEQUAL_VECTOR_SIZES";


   /**
    * Creates a new {@link ExampleBasedFMeasureTest}.
    */
   public ExampleBasedFMeasureTest() {
   ...
   public List<Pair<Pair<List<IVector>, List<IVector>>, Double>> getCorrectListofPairsListOfRatings() {
      ...
      correctListOfPairsListOfRatings.add(Pair.of(Pair.of(firstRatings, secondRatings), 148 / 231.0));
   ...
   public List<Pair<String, Pair<Pair<List<IVector>, List<IVector>>, Double>>> getWrongListOfPairsOfListOfRatingsWithExceptionMessage() {
      ...
      wrongListOfPairsOfListOfRatingsWithExceptionMessage.add(
            Pair.of(TestUtils.getStringByReflectionSafely(AAverageDecomposableIVectorDoubleMetric.class, REFLECTION_ERROR_CANNOT_AVERAGE),
