...
/**
 * This test tests the {@link ExampleBasedRecall} measure.
 * 
 * @author Alexander Hetzer
 *
 */
public class ExampleBasedRecallTest extends AAverageDecomposableIVectorDoubleMetricTest {

   private static final String RESOURCE_DIRECTORY_LEVEL = "example_based_recall" + File.separator;

   private static final String REFLECTION_ERROR_CANNOT_COMPUTE_RECALL_FOR_TWO_0_VECTORS = "ERROR_CANNOT_COMPUTE_RECALL_FOR_TWO_0_VECTORS";


   /**
    * Creates a new {@link ExampleBasedRecallTest}.
    */
   public ExampleBasedRecallTest() {
   ...
   public List<Pair<Pair<IVector, IVector>, Double>> getCorrectListofPairsOfRatings() {
      ...
      correctListOfPairsOfRatings.add(TestUtils.getArgumentAndExpectedResultPair(firstRating5, secondRating5, 4.0 / 4.0));
   ...
   public List<Pair<String, Pair<Pair<IVector, IVector>, Double>>> getWrongListOfPairsOfRatingsWithExceptionMessage() {
      ...
      double[] secondRating2 = { 1, 0, 1, 1, 0 };
      wrongListOfPairsOfRatingsWithExceptionMessage.add(TestUtils.getArgumentAndExpectedResultPairWithExpectedExceptionMessage(
            TestUtils.getArgumentAndExpectedResultPair(firstRating2, secondRating2, 0.0),
            TestUtils.getStringByReflectionSafely(ExampleBasedRecall.class, REFLECTION_ERROR_CANNOT_COMPUTE_RECALL_FOR_TWO_0_VECTORS)));
